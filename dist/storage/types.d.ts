export type DatasetName = 'users' | 'learningPlans' | 'progress' | 'gamification' | 'coaching' | 'subscriptions' | 'subscriptionTiers' | 'subscriptionEntitlements';
...
export type SubscriptionStatusValue = 'free' | 'trialing' | 'active' | 'past_due' | 'canceled' | 'incomplete' | 'incomplete_expired';
